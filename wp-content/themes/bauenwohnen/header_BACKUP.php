...
<html lang='de'>
	<head>
		...
		<!-- Default -->
		<link rel="icon" href="<?php bloginfo( 'template_directory' ); ?>/assets/favicon/favicon.svg" type="image/x-icon">
		...
		<link rel="icon" type="image/png" href="<?php bloginfo( 'template_directory' ); ?>/assets/favicon/favicon-194x194.png" sizes="194x194">
		<link rel="icon" type="image/png" href="<?php bloginfo( 'template_directory' ); ?>/assets/favicon/favicon-96x96.png" sizes="96x96">
		<link rel="icon" type="image/png" href="<?php bloginfo( 'template_directory' ); ?>/assets/favicon/favicon-192x192.png" sizes="192x192">
		...
		<link rel="apple-touch-icon" sizes="72x72" href="<?php bloginfo( 'template_directory' ); ?>/assets/favicon/apple-touch-icon-57x57.png">
		...
		<link rel="apple-touch-icon" sizes="192x192" href="<?php bloginfo( 'template_directory' ); ?>/assets/favicon/apple-touch-icon-192x192.png">

		<!-- Apple macOS Safari Mask Icon -->
		<link rel="mask-icon" href="<?php bloginfo( 'template_directory' ); ?>/assets/favicon/favicon.svg" color="#001C37">

		<!-- Apple iOS Safari Theme -->
		<meta name="apple-mobile-web-app-status-bar-style" content="#001C37">
		<meta name="apple-mobile-web-app-title" content="<?php bloginfo( 'name' ); ?>">
		<meta name="apple-mobile-web-app-capable" content="yes">

		<!-- Microsoft Windows Tiles -->
		<meta name="theme-color" content="#707173">
		<meta name="msapplication-navbutton-color" content="#001C37">
		<meta name="msapplication-TileColor" content="#838282">
		<meta name="msapplication-TileImage" content="<?php bloginfo( 'template_directory' ); ?>/assets/favicon/windows-tile-icon-144x144.png">
		<meta name="application-name" content="<?php bloginfo( 'name' ); ?>">

		<!-- Internet Explorer 11 Tiles -->
		<meta name="msapplication-square70x70logo" content="<?php bloginfo( 'template_directory' ); ?>/assets/favicon/ms-ie11-icon-70x70.png">
		<meta name="msapplication-square150x150logo" content="<?php bloginfo( 'template_directory' ); ?>/assets/favicon/ms-ie11-icon-150x150.png">
		<meta name="msapplication-wide310x150logo" content="<?php bloginfo( 'template_directory' ); ?>/assets/favicon/ms-ie11-icon-310x150.png">
		<meta name="msapplication-square310x310logo" content="<?php bloginfo( 'template_directory' ); ?>/assets/favicon/ms-ie11-icon-310x310.png">

		<!-- Open Graph -->
		<meta property="og:title" content="<?php bloginfo( 'name' ); ?>">
		<meta property="og:type" content="website">
		<meta property="og:url" content="https://www.bauenwohnen.com">
		<meta property="og:image" content="og_image_url">
		<meta property="og:site_name" content="Bauen & Wohnen Wohnbau GmbH">
			...
			<div class="site-header__branding">
				<div class="site-header__logo">
					<a class="header-logo__link wrapper" href="<?php echo get_home_url(); ?>">
						<img class="site-header__logo-img lazyload" src="<?php bloginfo( 'template_directory' ); ?>/assets/images/logos/logo_buw-3-lines_lightgray.svg" alt="Logo: Bauen & Wohnen Wohnbau GmbH">
					</a>
				</div>
			</div>
