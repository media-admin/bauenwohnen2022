...
<html lang='de'>
	<head>
		...
		<link rel="mask-icon" href="<?php bloginfo( 'template_directory' ); ?>/assets/favicon/favicon.svg" color="#B6274F">
			...
			<div class="site-header__branding">
				<div class="site-header__logo">
					<a class="header-logo__link wrapper" href="<?php echo get_home_url(); ?>">
						<img class="site-header__logo-img lazyload" src="<?php bloginfo( 'template_directory' ); ?>/assets/images/logos/logo-buw-3-lines_lightgray.svg" alt="Logo Bauen & Wohnen Wohnbau GmbH">
					</a>
				</div>
			</div>
