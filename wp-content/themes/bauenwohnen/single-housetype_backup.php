		...
		<section class="site-intro">
			<article class="wrapper">
				...
				<div class="single-housetype__content-container content-container">
					...
					<div class="single-housetype__plan-container fullwidth-wrapper content-container--blue">
						<div class="single-housetype__plan-floor1">
							<?php if( $image_plan_floor1 ): ?>
								<a href="<?php echo esc_url($image_plan_floor1_url); ?>" data-featherlight="image"><img src="<?php echo esc_url($image_plan_floor1['sizes']['large']); ?>" alt="<?php echo esc_attr($image_plan_floor1['alt']); ?>" /></a>
							<?php endif; ?>
						</div>
						<div class="single-housetype__plan-floor2">
							<?php if( $image_plan_floor2 ): ?>
								<a href="<?php echo esc_url($image_plan_floor2_url); ?>" data-featherlight="image"><img src="<?php echo esc_url($image_plan_floor2['sizes']['large']); ?>" alt="<?php echo esc_attr($image_plan_floor2['alt']); ?>" /></a>
							<?php endif; ?>
						</div>
						<div class="single-housetype__plan-basement">
							<?php if( $image_plan_basement ): ?>
								<a href="<?php echo esc_url($image_plan_basement_url); ?>" data-featherlight="image"><img src="<?php echo esc_url($image_plan_basement['sizes']['large']); ?>" alt="<?php echo esc_attr($image_plan_basement['alt']); ?>" /></a>
							<?php endif; ?>
						</div>
					</div>
